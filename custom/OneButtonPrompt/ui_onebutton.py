...
def _sanitize_obp_preset_values(values):
    result = dict(values)
    for key, choices in {
        "subject": subjects,
        "artist": artists,
        "chosensubjectsubtypeobject": subjectsubtypesobject,
        "chosensubjectsubtypehumanoid": subjectsubtypeshumanoid,
        "chosensubjectsubtypeconcept": subjectsubtypesconcept,
        "chosengender": genders,
    ...
    with gr.Tab(label="OneButtonPrompt"):
        ...
        def OBPPreset_changed_update_custom(selection):
                ...
                return [
                    ...
                    dropdown_update(choices=subjectsubtypeshumanoid, value=selected_opb_preset["chosensubjectsubtypehumanoid"]),
