(function () {
  ...
  <button type="button" class="sai-timeline-tool-button" data-node-action="timeline-swap-size" title="${escapeHtml(t('Swap landscape / portrait', '交换横竖屏'))}"><i class="fa-solid fa-rotate"></i><span>${escapeHtml(t('Swap', '交换'))}</span></button>
