...
dir = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "user"))
...
@PromptServer.instance.routes.get("/api/pysssss/autocomplete")
...
@PromptServer.instance.routes.post("/api/pysssss/autocomplete")
...
@PromptServer.instance.routes.get("/api/pysssss/loras")
